export const vehiclePath = 'vehicleCatalog';
...
export const vehicleAllBrands = 'vehicleCatalog/allBrands';
export const vehicleAllModelsByBrand = 'vehicleCatalog/allModelsByBrand';
...
export const regionUpdate = 'regionals/edit';
export const regionDelete = 'regionals/delete';
export const regionGetByID = 'regionals/getById';
